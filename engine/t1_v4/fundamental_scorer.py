...
class FundamentalScorer:
    ...
    def score(
        ...
        Returns:
            {
                "fundamental_total": float,    # 总分 0-8
                "roe_score": float,            # ROE 0-3
                "profit_growth": float,        # 净利润增速 0-3
                "pe_reasonable": float,        # PE合理性 0-2
            }
        """
    ...
    def _score_pe_reasonable(
        ...
        xp = [0, 0.3, 0.5, 1.5, 2.5, 4.0], fp = [0, 0.8, 2, 2, 0.8, 0]
        pe 或 industry_pe_median 为 None/0 时返回 1.0 分
        """
