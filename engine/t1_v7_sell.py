...
class T1V7SellEngine:
    """T1 v7 卖出引擎"""

    def __init__(self):
        self.open_profit_threshold = 1.0  # 开盘盈利≥1%卖出
        self.intraday_high_threshold = 2.0  # 盘中冲高≥2%卖出
        self.open_stop_loss = -4.0  # 开盘止损-4%
        self.fixed_sell_time = "09:40"  # 9:40卖出
    ...
    def decide_sell(
        ...
        # 优先级4: 9:40固定卖出
        return "fixed_time_940", next_close, "9:40固定卖出"
